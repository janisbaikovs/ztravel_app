CLASS zcl_generate_travel_data_jba DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_jba IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_jba.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_jba.

*   insert the new table entries
    INSERT ztravel_jba FROM TABLE @itab.
